...
def draw_boxes(image, out_scores, out_boxes, out_classes, class_names, colors):
    ...
    font = ImageFont.truetype(font='/Users/ryshen/Desktop/yolo-master/font/FiraMono-Medium.otf',size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
...
def predict(sess, in_file,out_file):
    ...
    print('Found {} boxes for {}'.format(len(out_boxes), in_file))
...
class_names = read_classes("/Users/ryshen/Desktop/yolo-master/model_data/coco_classes.txt")  #所需classes
anchors = read_anchors("/Users/ryshen/Desktop/yolo-master/model_data/yolo_anchors.txt")  #anchors参数
image_shape = (800., 1200.)   #输入图片大小 (800., 1200.) 视频每帧大小
max_boxes=20 #最多发现车辆数
yolo_model = load_model("/Users/ryshen/Desktop/yolo-master/model_data/yolo.h5")  #载入model
...
# out_scores, out_boxes, out_classes = predict(sess, "/Users/ryshen/Desktop/yolo-master/images/timg3.jpg","/Users/ryshen/Desktop/yolo-master/out/alchemist.jpg")
