...
VIDEO_PATH = '/Users/ryshen/Desktop/yolo-master/video/test.mp4'  # 源视频地址
EXTRACT_FOLDER = '//Users//ryshen//Desktop//yolo-master//video//out.mp4'  # 生成视频存放的位置
EXTRACT_FREQUENCY = 3  # 帧提取频率，每3帧提取一张分析
FPS = 10   #形成视频的每秒帧数
#建议  EXTRACT_FREQUENCY*FPS 等于源视频的每秒帧数
SIZE = (1748,984)  #输出视频大小
